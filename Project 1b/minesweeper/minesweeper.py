...
class Sentence():
    ...
    def known_mines(self):
        ...
        # If the number of cells in the sentence is equal to the count, all are mines
        if len(self.cells) == self.count and self.count > 0:
            print(f"Known mines: {self.cells}")
            return self.cells
        else:
            return set()
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        # based on the value of cell and count, to indicate that count of the cell’s 
        ...
        new_knowledge = Sentence(undetermined_cells, count)
        self.knowledge.append(new_knowledge)
        print(f"New knowledge 1: {new_knowledge}")
            ...
            for other_sentence in self.knowledge:
                ...
                if other_sentence.cells.issubset(sentence.cells):
                    ...
                    if new_sentence not in self.knowledge:
                        ...
                        print(f"New knowledge 2: {new_sentence}")

        # Remove empty sentences
        for sentence in self.knowledge:
            if len(sentence.cells) == 0:
                self.knowledge.remove(sentence)
                print(f"Removed empty sentence: {sentence}")

        # Print knowledge
        print(f"Knowledge base length: {len(self.knowledge)}")
    ...
    def make_safe_move(self):
        ...
        """
        # Create set for safe moves
        safe_moves = []

        # Add all safe moves to set
